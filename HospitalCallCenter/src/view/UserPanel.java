...
public class UserPanel extends JPanel {
    ...
    public UserPanel(View view) {
        ...
        UserMenuButton.addActionListener(e -> view.showPanel("menuPanel")); // Acción para mostrar el LoginPanel
        add(UserMenuButton);
        ...
        UserBackLoginButton.addActionListener(e -> view.showPanel("loginPanel")); // Acción para mostrar el LoginPanel
